...
class APITest(TestCase):
    ...
    print(model)
    '''
    def test_schema(self, *args, **kwargs):
    ...
    def test_assert(self, *args, **kwargs):

        print('adasdsadasdasdasdasd')
        global model
        model = model
        print(model)
        if model:
            ...
            #Preload
            occupantsId = []
            for o in modelSim.occupants:
                occupantsId.append(o.unique_id)
            ...
            for i in range(N):
                ...
                datajson = data.json()
                print("Response: ", datajson)
                occupantsGetted = datajson['occupants']
                TestCase.assertCountEqual(occupantsGetted, occupantsId)
